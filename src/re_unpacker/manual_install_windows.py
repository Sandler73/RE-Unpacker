...
def _add_install_dir_to_system_path(*, logger: logging.Logger) -> bool:
    ...
    Lesson L44: Windows shows a modal "PATH env variable too big"
...
_OUT_OF_SCOPE: dict[str, str] = {
    "signtool":  "Windows SDK (user has SDK installed; out-of-scope per Q3)",
    "apksigner": "Android SDK (out-of-scope per Q3)",
    "apktool":   "Android SDK (out-of-scope per Q3)",
}
...
def _dispatch_handler(
    ...
    *,
    ...
    # Lesson L42: asset_name_hint MUST be 'win-x64' not 'x64'.
    ...
    *,
    ...
    for tool_name in tool_names:
        ...
        for r in results:
            ...
            # Lesson L39: log per-tool result so the
