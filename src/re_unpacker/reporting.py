...
# =============================================================================
# v0.3.2: Verification + Classification rendering for summary.txt
# =============================================================================
...
def write_summary_report(
    ...
    *,
    ...
    # =========================================================================
    # v0.3.2: Subsystem B (verification) breakdown
    # =========================================================================
    lines.append("=" * 72)
    lines.append("Signature verification results (Subsystem B, v0.3.2)")
    lines.append("=" * 72)
    _append_verification_section(lines, files)
    lines.append("")

    # =========================================================================
    # v0.3.2: Subsystem C (classification) breakdown
    # =========================================================================
    lines.append("=" * 72)
    lines.append("Classification enrichment summary (Subsystem C, v0.3.2)")
    lines.append("=" * 72)
