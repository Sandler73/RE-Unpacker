...
TOOL_PACKAGE_HINTS_LINUX: dict[str, str] = {
    ...
    "objcopy": "binutils",
    "readelf": "binutils",
    # ---- v0.2.0 additions: extended unpack toolset ----
    ...
    "apt-get": "apt",
    "dpkg-query": "dpkg",
    # ---- v0.3.0 additions: extraction-depth subsystem (Subsystem A) ----
    # PDF
    ...
    "mcopy": "mtools",
    # =========================================================================
    # v0.3.2: Subsystem B (verification) tools
    # =========================================================================
    ...
    # =========================================================================
    # v0.3.2: Subsystem C (classification) tools
    # =========================================================================
...
# -----------------------------------------------------------------------------
# Tool -> Windows winget Package Identifier map (v0.4.0)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# v0.3.2: Subsystem C (classification) constants
# -----------------------------------------------------------------------------
...
#
# v0.4.0: now resolved via platform_compat.default_yara_rule_dirs() so the
...
# -----------------------------------------------------------------------------
# Manual-install instructions for Windows tools (v0.4.0)
# -----------------------------------------------------------------------------
...
KNOWN_UNAVAILABLE_PACKAGES_WINDOWS: dict[str, str] = {
    ...
    "osslsigncode": (
        ...
        "PowerShellAuthenticodeVerifier and SigntoolVerifier (added in "
        "v0.4.0) are Windows-native alternatives that don't require "
        "osslsigncode."
    ),
    "signtool": (
...
MAGIC_SIGNATURES: dict[str, list[tuple[bytes, int]]] = {
    ...
    # ---- v0.2.0 additions: extended unpack format magic ----
    ...
    # ---- v0.3.0 additions: extraction-depth subsystem ----
    # VM disk images
...
EXTENSION_HINTS: dict[str, str] = {
    ...
    ".sys": "PE_EXECUTABLE",
    ".iso": "ISO",
    # ".img" is defined once, below, with its refined RAW_DISK value (v0.3.0).
    ".dmg": "DMG",
    ".appimage": "APPIMAGE",
    ".snap": "SNAP",
    ".squashfs": "SQUASHFS",
    ...
    ".war": "ZIP",
    ".ear": "ZIP",
    # ".apk" is defined once, below, with its refined APK value (v0.3.0).
    ".ipa": "ZIP",
    ".xpi": "ZIP",
    ".crx": "ZIP",
    ".nupkg": "ZIP",
