...
class FileEntry:
    ...
    Schema 1.0.0 fields (v0.1.x through v0.3.1) are listed first; schema
    1.1.0 additions (v0.3.2) are listed at the end and are all OPTIONAL with
    sensible defaults. Older manifest readers that don't know about the
    1.1.0 fields can ignore them; newer readers loading 1.0.0 manifests get
...
class RunStats:
    ...
    Schema 1.0.0 counters first, schema 1.1.0 additions at the end.
    """
    ...
    # Schema 1.1.0 additions (v0.3.2) -- enrichment + verification counters
