...
class FileEntry:
    ...
    Schema fields (v0.1.x through) are listed first; schema
    additions are listed at the end and are all OPTIONAL with
    sensible defaults. Older manifest readers that don't know about the
    fields can ignore them; newer readers loading manifests get
