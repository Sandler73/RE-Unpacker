...
class RecursiveUnpacker:
    ...
    def __init__(
        ...
        *,
        ...
        # v0.3.2 additions: verifier + classifier configuration
        ...
        # v0.3.2 enrichment registries (default to canonical builds when
    ...
    def run(self) -> RunStats:
        ...
        # v0.3.2: Enrichment phase. Runs after extraction completes;
    ...
    def _dispatch(
        ...
        *,
        ...
        # v0.3.0: filter root-requiring extractors when we are not root.
        ...
        if self.extract_resources:
            ...
            # v0.3.0: same root-requirement filter as primaries.
            if secondaries:
    ...
    def _run_single_extractor(
        ...
        *,
        ...
        try:
            ...
            # "per-archive file count" tracked via total_files here
            with self._stats_lock:
